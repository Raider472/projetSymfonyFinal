 ...
 */
final class Version20231224214122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE figurine (id INT AUTO_INCREMENT NOT NULL, image_id INT NOT NULL, faction_id INT NOT NULL, stats_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, points INT NOT NULL, status ENUM(\'En Stock\', \'Hors Stock\', \'Précommande\') NOT NULL COMMENT \'(DC2Type:type_of_status_enum)\', UNIQUE INDEX UNIQ_9DD64783DA5256D (image_id), INDEX IDX_9DD64784448F8DA (faction_id), UNIQUE INDEX UNIQ_9DD647870AA3482 (stats_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE figurine_stats (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, movement INT NOT NULL, toughness INT NOT NULL, save INT NOT NULL, wound INT NOT NULL, leadership INT NOT NULL, oc INT NOT NULL, min_model INT NOT NULL, max_models INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE melee_weapon (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, number_of_attacks VARCHAR(255) NOT NULL, weapon_skill INT NOT NULL, strenght INT NOT NULL, armor_penetration INT NOT NULL, damage VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paint (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, status ENUM(\'En Stock\', \'Hors Stock\', \'Précommande\') NOT NULL COMMENT \'(DC2Type:type_of_status_enum)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
